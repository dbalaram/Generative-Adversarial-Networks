    ...
    def vocabulary(self):
        ...
        if os.path.exists(vocabulary_path):
            with open(vocabulary_path, 'rb') as vocabulary_file:
                self._vocabulary = pickle.load(vocabulary_file)
